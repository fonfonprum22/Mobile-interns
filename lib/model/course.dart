...
var recentCourses = [
  Course(
    courseSubtitle: "Meajo University",
    courseTitle: "MyEducation",
  ...
  Course(
    courseSubtitle: "22 July 1999 I'am 21 yearOld",
    courseTitle: "My Birthday",
    background: LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
      colors: [
  ...
  Course(
    courseSubtitle: "Feacbook:FonFonprum  Phone:095-134-6651",
    courseTitle: "My social contact",
    background: LinearGradient(
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
      colors: [
